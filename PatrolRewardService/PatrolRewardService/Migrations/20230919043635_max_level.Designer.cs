...
namespace PatrolRewardService.Migrations
{
    ...
    [Migration("20230919043635_max_level")]
    partial class max_level
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PatrolRewardService.Models.ClaimModel", b =>
                {
                    ...
                    b.HasIndex("TxId")
                        .IsUnique()
                        .HasDatabaseName("ix_claims_tx_id");
            ...
            modelBuilder.Entity("PatrolRewardService.Models.TransactionModel", b =>
                {
                    ...
                    b.HasAlternateKey("AvatarAddress", "ClaimCount")
                        .HasName("ak_transactions_avatar_address_claim_count");
            ...
            modelBuilder.Entity("PatrolRewardService.Models.ClaimModel", b =>
                {
                    ...
                    b.HasOne("PatrolRewardService.Models.TransactionModel", "Transaction")
                        .WithOne("Claim")
                        .HasForeignKey("PatrolRewardService.Models.ClaimModel", "TxId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_claims_transactions_tx_id");
